...
def generate_sentences():
    subjects = ["The cat", "A scientist", "A pinnedyr", "Diddy", "Kobi", "De Meikel", "Jones", "Anadrius", "Fiskus", "Your friend", "The robot", "Fantorangen", "Someone", "An artist", "A dog", "This device", "The teacher", "Our neighbor"]
